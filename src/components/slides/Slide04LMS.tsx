...
import lmsLogo from "@/assets/maus-lms-logo.svg";
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 grid grid-cols-[1.15fr_1fr] items-center gap-[80px] px-[160px]">
          ...
          <div>
            ...
            >
              Build and share knowledge inside your team.
              <br />
              A lightweight learning platform made by MAUS,
              <br />
